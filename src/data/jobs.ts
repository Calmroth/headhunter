...
export const JOBS_LAST_UPDATED = '2026-06-25';
...
export const JOBS: Job[] = [
  // Stockholm
  // north-kingdom: unreachable — keeping existing
  ...
  // Helsinki
  // bond: unreachable — keeping existing
  ...
  // wolff-olins: unreachable — keeping existing
  ...
  // afry-stockholm: reachable — UX/UI Designer confirmed live; keeping existing + live role updated
  ...
  { id: 'j-48', firmId: 'afry-stockholm', title: 'UX Designer, Industry Digital', discipline: 'UX Designer', seniority: 'Mid', postedAt: '2026-06-25', agentFound: true },
  // afry-gothenburg: reachable — no open design roles found; keeping existing
  ...
  // nexer-gothenburg: reachable — live Service Designer role found; keeping existing + adding new
  { id: 'j-50', firmId: 'nexer-gothenburg', title: 'Lead Experience Designer', discipline: 'UX Designer', seniority: 'Lead', postedAt: daysAgo(1) },
  { id: 'nexer-gothenburg-senior-service-designer', firmId: 'nexer-gothenburg', title: 'Senior Service Designer', discipline: 'UX Designer', seniority: 'Senior', postedAt: '2026-06-25', agentFound: true },
  // nexer-stockholm: reachable — live UX Designer role found; keeping existing + adding new
  { id: 'j-51', firmId: 'nexer-stockholm', title: 'Senior UI Designer', discipline: 'UI Designer', seniority: 'Senior', postedAt: daysAgo(5) },
  { id: 'nexer-stockholm-ux-designer', firmId: 'nexer-stockholm', title: 'UX Designer', discipline: 'UX Designer', seniority: 'Mid', postedAt: '2026-06-25', agentFound: true },
  // knowit-stockholm: reachable — no new open creative roles found in listing; keeping existing
  ...
  // knowit-oslo: reachable — live UX Designer role found; keeping existing
  { id: 'j-54', firmId: 'knowit-oslo', title: 'Senior UX Designer', discipline: 'UX Designer', seniority: 'Senior', postedAt: daysAgo(6) },
  // knowit-helsinki: reachable — live Senior Service Designer found; keeping existing
  { id: 'j-55', firmId: 'knowit-helsinki', title: 'Brand Designer', discipline: 'Brand Designer', seniority: 'Mid', postedAt: daysAgo(2) },
  { id: 'knowit-helsinki-senior-service-designer', firmId: 'knowit-helsinki', title: 'Senior Service Designer', discipline: 'UX Designer', seniority: 'Senior', postedAt: '2026-06-25', agentFound: true },
  // tietoevry-helsinki: reachable — no open creative roles found; keeping existing
  ...
  // tietoevry-stockholm: reachable — two UX roles found live; keeping existing + adding new
  { id: 'j-57', firmId: 'tietoevry-stockholm', title: 'Lead UI Designer', discipline: 'UI Designer', seniority: 'Lead', postedAt: daysAgo(8) },
  { id: 'tietoevry-stockholm-senior-ux-ui-designer', firmId: 'tietoevry-stockholm', title: 'Senior UX/UI Designer', discipline: 'UX Designer', seniority: 'Senior', postedAt: '2026-06-25', agentFound: true },
  // visma-oslo: reachable — Product Designer + UX/UI Designer found live
  { id: 'j-58', firmId: 'visma-oslo', title: 'Senior Product Designer', discipline: 'UI Designer', seniority: 'Senior', postedAt: daysAgo(5) },
  { id: 'visma-oslo-product-designer', firmId: 'visma-oslo', title: 'Product Designer', discipline: 'UI Designer', seniority: 'Mid', postedAt: '2026-06-25', agentFound: true },
  // cognizant-london: reachable — no open creative roles found; keeping existing
  ...
  // cognizant-newyork: reachable — Digital Product Designer found live
  ...
  { id: 'cognizant-newyork-digital-product-designer', firmId: 'cognizant-newyork', title: 'Digital Product Designer', discipline: 'UI Designer', seniority: 'Mid', postedAt: '2026-06-08', agentFound: true },
  // tcs-interactive-london: unreachable — keeping existing
  ...
  // infosys-wongdoody-london: reachable — 3 roles found live; keeping existing + adding confirmed roles
  { id: 'j-62', firmId: 'infosys-wongdoody-london', title: 'Art Director', discipline: 'Art Director', seniority: 'Senior', postedAt: daysAgo(4) },
  { id: 'infosys-wongdoody-london-creative-director', firmId: 'infosys-wongdoody-london', title: 'Creative Director', discipline: 'Creative Director', seniority: 'Senior', postedAt: '2026-06-25', agentFound: true },
  { id: 'infosys-wongdoody-london-senior-ux-designer', firmId: 'infosys-wongdoody-london', title: 'Senior UX Designer', discipline: 'UX Designer', seniority: 'Senior', postedAt: '2026-06-25', agentFound: true },
  { id: 'infosys-wongdoody-london-ux-director', firmId: 'infosys-wongdoody-london', title: 'UX Director', discipline: 'UX Designer', seniority: 'Lead', postedAt: '2026-06-25', agentFound: true },

  // Global enterprise consultancies (Band B)
  // accenture-song-london: unreachable — keeping existing
  ...
  // deloitte-digital-newyork: unreachable — keeping existing
  ...
  // ideo-sanfrancisco: unreachable — keeping existing
  ...
  // mckinsey-design-newyork: unreachable — keeping existing
  ...
  // mckinsey-design-stockholm: unreachable — keeping existing
  ...
  // designit-copenhagen: unreachable — keeping existing
  ...
  // ibm-ix-newyork: unreachable — keeping existing
  ...
  // publicis-sapient-newyork: unreachable — keeping existing
  ...
  // publicis-sapient-london: unreachable — keeping existing
  ...
  // ey-doberman-stockholm: unreachable — keeping existing
